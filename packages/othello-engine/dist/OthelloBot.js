import { getValidMoves, isGameOver, score, E } from './index';
...
export class OthelloBot {
     ...
     * ```
     */
    calculateMove(board, moveHistory) {
        this.nodesSearched = 0;
     ...
     * @private
     */
    getMinimaxMove(board, validMoves) {
    ...
    evaluatePosition(board) {
        ...
        // Disc count value
        const discValue = this.player === 'B' ? scores.black - scores.white : scores.white - scores.black;
